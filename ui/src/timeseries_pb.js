...
goog.exportSymbol('proto.timeseries.TimeSeriesRequest', null, global);
/**
 ...
 * @constructor
 */
proto.timeseries.TimeSeriesRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.timeseries.TimeSeriesRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.timeseries.TimeSeriesRequest.displayName = 'proto.timeseries.TimeSeriesRequest';
}
 ...
 * @return {!Object}
 */
proto.timeseries.TimeSeriesRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.timeseries.TimeSeriesRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.timeseries.TimeSeriesRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.timeseries.TimeSeriesRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    key: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.timeseries.TimeSeriesRequest}
 */
proto.timeseries.TimeSeriesRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.timeseries.TimeSeriesRequest;
  return proto.timeseries.TimeSeriesRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.timeseries.TimeSeriesRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.timeseries.TimeSeriesRequest}
 */
proto.timeseries.TimeSeriesRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.timeseries.TimeSeriesRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.timeseries.TimeSeriesRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.timeseries.TimeSeriesRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.timeseries.TimeSeriesRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getKey();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.timeseries.TimeSeriesRequest.prototype.getKey = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.timeseries.TimeSeriesRequest} returns this
 */
proto.timeseries.TimeSeriesRequest.prototype.setKey = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.timeseries.TimeSeriesRequest.prototype.getFromTimestamp = function() {
 ...
 * @return {!proto.timeseries.TimeSeriesRequest} returns this
 */
proto.timeseries.TimeSeriesRequest.prototype.setFromTimestamp = function(value) {
 ...
 * @return {number}
 */
proto.timeseries.TimeSeriesRequest.prototype.getToTimestamp = function() {
 ...
 * @return {!proto.timeseries.TimeSeriesRequest} returns this
 */
proto.timeseries.TimeSeriesRequest.prototype.setToTimestamp = function(value) {
